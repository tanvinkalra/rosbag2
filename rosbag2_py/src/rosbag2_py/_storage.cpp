...
PYBIND11_MODULE(_storage, m) {
  ...
  .def(
    ...
    pybind11::arg("enable_throughput_predictive_flush") = false)
  ...
  .def_readwrite(
    "enable_throughput_predictive_flush",
    &rosbag2_storage::StorageOptions::enable_throughput_predictive_flush);
