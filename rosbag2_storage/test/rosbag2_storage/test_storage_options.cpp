...
TEST(storage_options, test_yaml_serialization)
{
  ...
  original.enable_throughput_predictive_flush = true;
  ...
  ASSERT_EQ(original.enable_throughput_predictive_flush, reconstructed.enable_throughput_predictive_flush);
}
